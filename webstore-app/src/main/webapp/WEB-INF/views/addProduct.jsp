		...
		<form:form method="POST" modelAttribute="newProduct" class="form-horizontal">
			<fieldset>
				...
				<div class="form-group">
					...
					<div class="col-lg-10">
						<form:input id="uintsInStock" path="unitsInStock"
						type="text" class="form:input-large"/>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-lg-10">
						...
						value="New" /><spring:message code="addProduct.form.condition.New.label"/>
						<form:radiobutton path="condition"
						value="Old" /><spring:message code="addProduct.form.condition.Old.label"/>
						<form:radiobutton path="condition"
